...
def search_images(search_paths):
  ...
  if not valid_result:
    ...
    # plt.savefig('/Users/dhruvroongta/PycharmProjects/basics/CalHacks/website/search_result.png')
...
if not utility.has_collection(COLLECTION_NAME):
  ...
  add_images_to_database('/Users/dhruvroongta/Downloads/CalHacksNewImages')
else:
